...
Widget JadwalCateringTangsel(String collectionNama) {
                            ...
                            Center(
                              child: Padding(
                                padding: const EdgeInsets.only(
                                    left: 50, right: 40, top: 9, bottom: 5),
                                child: Text(
                                  _documentSnapshot['nama_'],
                                  style: GoogleFonts.poppins(
                                    color: Colors.white,
                                    fontSize: 16,
                                  ...
                                  child: Row(children: [
                                    ...
                                    Expanded(
                                      child: Padding(
                                        ...
                                        child: Text(_documentSnapshot['porsi_'] + " Porsi",
                                            style: GoogleFonts.poppins(
                                                fontSize: 19,
                                                color: kblackcolor,
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        child: Padding(
                                          ...
                                          child: Text(_documentSnapshot['rute_'],
                                              style: AppStyle.mainTitleeee),
                                        ),
                                      ),
                                    ],
