...
class EditPageRabuTangsel extends StatefulWidget {
  EditPageRabuTangsel(this.docs, {Key? key}) : super(key: key);
  QueryDocumentSnapshot docs;

  @override
  _EditPageRabuTangselState createState() => _EditPageRabuTangselState();
}

class _EditPageRabuTangselState extends State<EditPageRabuTangsel> {
      ...
      body: SafeArea(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('add_customers_tangsel_Rabu')
