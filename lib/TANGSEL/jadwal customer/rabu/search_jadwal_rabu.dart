import '/Depok/jadwal%20customer/rabu/screen_jadwal.dart';
import '/Depok/jadwal%20customer/senin/screen_jadwal.dart';
import '/TANGSEL/jadwal%20customer/rabu/screen_jadwal.dart';
import '/theme.dart';
...
Future<void> main() async {
  ...
  runApp(searchJadwalRabuTangsel());
}

class searchJadwalRabuTangsel extends StatefulWidget {
  //const searchJadwalRabuTangsel({Key? key}) : super(key: key);

  @override
  State<searchJadwalRabuTangsel> createState() => _searchJadwalRabuTangselState();
}

class _searchJadwalRabuTangselState extends State<searchJadwalRabuTangsel> {
  // String _bayar = 'Lunas';
  String nama = '';
  bool _isShown = true;
  ...
  Widget build(BuildContext context) {
    CollectionReference customers =
        FirebaseFirestore.instance.collection('add_customers_tangsel_rabu');
                    ...
                    children: snapshot.data!.docs.map(
                      (customers) {
                        ...
                        if (customers['nama_']
                          ...
                          return SearchScreenJadwalRabu_Tangsel(() {
