import '/Depok/jadwal%20customer/kamis/screen_jadwal.dart';
import '/Depok/jadwal%20customer/senin/screen_jadwal.dart';
import '/TANGSEL/jadwal%20customer/kamis/screen_jadwal.dart';
import '/theme.dart';
...
Future<void> main() async {
  ...
  runApp(searchJadwalKamisTangsel());
}

  class searchJadwalKamisTangsel extends StatefulWidget {
  //const searchJadwalKamisTangsel({Key? key}) : super(key: key);
  @override
  State<searchJadwalKamisTangsel> createState() => _searchJadwalKamisTangselState();
}
class _searchJadwalKamisTangselState extends State<searchJadwalKamisTangsel> {
  // String _bayar = 'Lunas';
  String nama = '';
  bool _isShown = true;
  ...
  Widget build(BuildContext context) {
    CollectionReference customers =
        FirebaseFirestore.instance.collection('add_customers_tangsel_kamis');
                    ...
                    children: snapshot.data!.docs.map(
                      (customers) {
                        ...
                        if (customers['nama_']
                            ...
                            // .toLowerCase()
                            // .startsWith(nama.toLowerCase()));
                          return SearchScreenJadwalKamis_Tangsel(() {
                          }, customers);
                        }
                        if (nama.isEmpty) {
                          return Center();
