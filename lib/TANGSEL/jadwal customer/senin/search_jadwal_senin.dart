...
import '/TANGSEL/jadwal%20customer/senin/screen_jadwal.dart';
import '/theme.dart';
...
Future<void> main() async {
  ...
  runApp(searchJadwalSeninTangsel());
}

class searchJadwalSeninTangsel extends StatefulWidget {
  //const searchJadwalSeninTangsel({Key? key}) : super(key: key);

  @override
  State<searchJadwalSeninTangsel> createState() => _searchJadwalSeninTangselState();
}

class _searchJadwalSeninTangselState extends State<searchJadwalSeninTangsel> {
  // String _bayar = 'Lunas';
  String nama = '';
  bool _isShown = true;
  ...
  Widget build(BuildContext context) {
    CollectionReference customers =
        FirebaseFirestore.instance.collection('add_customers_tangsel_senin');
