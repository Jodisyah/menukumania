...
class EditPageSeninTangsel extends StatefulWidget {
  EditPageSeninTangsel(this.docs, {Key? key}) : super(key: key);
  QueryDocumentSnapshot docs;

  @override
  _EditPageSeninTangselState createState() => _EditPageSeninTangselState();
}

class _EditPageSeninTangselState extends State<EditPageSeninTangsel> {
      ...
      body: SafeArea(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('add_customers_tangsel_senin')
