...
class EditPageJumatTangsel extends StatefulWidget {
  EditPageJumatTangsel(this.docs, {Key? key}) : super(key: key);
  QueryDocumentSnapshot docs;

  @override
  _EditPageJumatTangselState createState() => _EditPageJumatTangselState();
}

class _EditPageJumatTangselState extends State<EditPageJumatTangsel> {
