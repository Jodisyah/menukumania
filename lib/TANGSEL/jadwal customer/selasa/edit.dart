...
class EditPageSelasaTangsel extends StatefulWidget {
  EditPageSelasaTangsel(this.docs, {Key? key}) : super(key: key);
  QueryDocumentSnapshot docs;

  @override
  _EditPageSelasaTangselState createState() => _EditPageSelasaTangselState();
}

class _EditPageSelasaTangselState extends State<EditPageSelasaTangsel> {
      ...
      body: SafeArea(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('add_customers_tangsel_selasa')
