...
Future<void> main() async {
  ...
  runApp(const SearchTangsel());
}

class SearchTangsel extends StatefulWidget {
  const SearchTangsel({Key? key}) : super(key: key);

  @override
  State<SearchTangsel> createState() => _SearchTangselState();
}

class _SearchTangselState extends State<SearchTangsel> {
