...
Future<void> main() async {
  ...
  runApp(searchJadwalRabu());
}

class searchJadwalRabu extends StatefulWidget {
  //const searchJadwalRabu({Key? key}) : super(key: key);

  @override
  State<searchJadwalRabu> createState() => _searchJadwalRabuState();
}

class _searchJadwalRabuState extends State<searchJadwalRabu> {
  // String _bayar = 'Lunas';
  String nama = '';
  bool _isShown = true;
  ...
  Widget build(BuildContext context) {
    CollectionReference customers =
        FirebaseFirestore.instance.collection('add_customers_rabu');
