...
class EditPageRabu extends StatefulWidget {
  EditPageRabu(this.docs, {Key? key}) : super(key: key);
  QueryDocumentSnapshot docs;

  @override
  _EditPageRabuState createState() => _EditPageRabuState();
}

class _EditPageRabuState extends State<EditPageRabu> {
