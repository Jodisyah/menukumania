...
Future<void> main() async {
  ...
  runApp(searchJadwalSenin());
}

class searchJadwalSenin extends StatefulWidget {
  //const searchJadwalSenin({Key? key}) : super(key: key);

  @override
  State<searchJadwalSenin> createState() => _searchJadwalSeninState();
}

class _searchJadwalSeninState extends State<searchJadwalSenin> {
  // String _bayar = 'Lunas';
  String nama = '';
  bool _isShown = true;
