...
class EditPageSenin extends StatefulWidget {
  EditPageSenin(this.docs, {Key? key}) : super(key: key);
  QueryDocumentSnapshot docs;

  @override
  _EditPageSeninState createState() => _EditPageSeninState();
}

class _EditPageSeninState extends State<EditPageSenin> {
