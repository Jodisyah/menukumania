...
class EditPageSelasa extends StatefulWidget {
  EditPageSelasa(this.docs, {Key? key}) : super(key: key);
  QueryDocumentSnapshot docs;

  @override
  _EditPageSelasaState createState() => _EditPageSelasaState();
}

class _EditPageSelasaState extends State<EditPageSelasa> {
      ...
      body: SafeArea(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('add_customers_selasa')
