...
class EditPageJumat extends StatefulWidget {
  EditPageJumat(this.docs, {Key? key}) : super(key: key);
  QueryDocumentSnapshot docs;

  @override
  _EditPageJumatState createState() => _EditPageJumatState();
}

class _EditPageJumatState extends State<EditPageJumat> {
