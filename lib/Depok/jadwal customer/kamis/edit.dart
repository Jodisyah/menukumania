...
class EditPageKamis extends StatefulWidget {
  EditPageKamis(this.docs, {Key? key}) : super(key: key);
  QueryDocumentSnapshot docs;

  @override
  _EditPageKamisState createState() => _EditPageKamisState();
}

class _EditPageKamisState extends State<EditPageKamis> {
      ...
      body: SafeArea(
        ...
        child: StreamBuilder(
          stream: FirebaseFirestore.instance
              .collection('add_customers_kamis')
