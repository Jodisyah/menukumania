...
Future<void> main() async {
  ...
  runApp(searchJadwalKamis());
}

class searchJadwalKamis extends StatefulWidget {
  //const searchJadwalKamis({Key? key}) : super(key: key);

  @override
  State<searchJadwalKamis> createState() => _searchJadwalKamisState();
}

class _searchJadwalKamisState extends State<searchJadwalKamis> {
  // String _bayar = 'Lunas';
  String nama = '';
  bool _isShown = true;
  ...
  Widget build(BuildContext context) {
    CollectionReference customers =
        FirebaseFirestore.instance.collection('add_customers_kamis');
