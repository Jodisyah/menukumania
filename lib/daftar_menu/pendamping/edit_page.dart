...
class EditTakaranPendamping extends StatefulWidget {
  EditTakaranPendamping({
    Key? key,
    required this.docs,
  }) : super(key: key);
  QueryDocumentSnapshot docs;
  @override
  _EditTakaranPendampingState createState() => _EditTakaranPendampingState();
}

class _EditTakaranPendampingState extends State<EditTakaranPendamping> {
