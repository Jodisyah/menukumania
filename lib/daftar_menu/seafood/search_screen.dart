...
Future<void> main() async {
  ...
  runApp(searchSeafood());
}

class searchSeafood extends StatefulWidget {
  //const searchSeafood({Key? key}) : super(key: key);

  @override
  State<searchSeafood> createState() => _searchSeafoodState();
}

class _searchSeafoodState extends State<searchSeafood> {
  // String _bayar = 'Lunas';
  String nama = '';
  bool _isShown = true;
  ...
  Widget build(BuildContext context) {
    CollectionReference customers =
        FirebaseFirestore.instance.collection('Takaran_seafood');
    FirebaseFirestore.instance.collection('Takaran_seafood').where('nama').get();
                        ...
                        if (customers['nama']
                          ...
                          SeafoodScreenHome((){
                            Navigator.push(
                                context,
                                MaterialPageRoute(
                                  builder: (context) => EditTakaranSeafood(docs: customers,),
                                ));
                          }, customers);
                        }
                        return Container();
