...
class seafoodAddPage extends StatefulWidget {
  const seafoodAddPage({Key? key}) : super(key: key);

  @override
  State<seafoodAddPage> createState() => _seafoodAddPageState();
}

class _seafoodAddPageState extends State<seafoodAddPage> {
  ...
  Widget build(BuildContext context) {
    CollectionReference Menu = FirebaseFirestore.instance.collection('Takaran_seafood');

    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        backgroundColor: Color(0xffF99B45),
        title: const Text("Tambah Menu Seafood"),
      ),
      body: Padding(
