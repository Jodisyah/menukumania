...
class EditTakaranSeafood extends StatefulWidget {
  EditTakaranSeafood({
    Key? key,
    required this.docs,
  }) : super(key: key);
  ...
  @override
  _EditTakaranSeafoodState createState() => _EditTakaranSeafoodState();
}

class _EditTakaranSeafoodState extends State<EditTakaranSeafood> {
