...
class EditTakaranAyam extends StatefulWidget {
  EditTakaranAyam({
    Key? key,
    required this.docs,
  }) : super(key: key);
  ...
  @override
  _EditTakaranAyamState createState() => _EditTakaranAyamState();
}

class _EditTakaranAyamState extends State<EditTakaranAyam> {
