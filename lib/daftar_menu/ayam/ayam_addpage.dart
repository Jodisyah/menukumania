...
class ayamAddPage extends StatefulWidget {
  const ayamAddPage({Key? key}) : super(key: key);

  @override
  State<ayamAddPage> createState() => _ayamAddPageState();
}

class _ayamAddPageState extends State<ayamAddPage> {
  ...
  Widget build(BuildContext context) {
    CollectionReference Menu = FirebaseFirestore.instance.collection('Takaran_ayam');

    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        backgroundColor: Color(0xffF99B45),
        title: const Text("Tambah Menu Ayam"),
      ),
      body: Padding(
