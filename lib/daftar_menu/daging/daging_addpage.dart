...
class dagingAddPage extends StatefulWidget {
  const dagingAddPage({Key? key}) : super(key: key);

  @override
  State<dagingAddPage> createState() => _dagingAddPageState();
}

class _dagingAddPageState extends State<dagingAddPage> {
  ...
  Widget build(BuildContext context) {
    CollectionReference Menu = FirebaseFirestore.instance.collection('Takaran_daging');

    return Scaffold(
      appBar: AppBar(
        elevation: 0,
        backgroundColor: Color(0xffF99B45),
        title: const Text("Tambah Menu Daging"),
      ),
      body: Padding(
